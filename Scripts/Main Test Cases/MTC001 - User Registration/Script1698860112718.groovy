...
WebUI.verifyElementText(findTestObject('Page_ParaBank_Customer_Created/lblWelcome'), GlobalVariable.expectedWelcomeMessage + 
    username)

WebUI.verifyElementText(findTestObject('Page_ParaBank_Customer_Created/lblSuccessfulAccountCreation'), GlobalVariable.expectedSuccessfulAccountCreationMessage)
