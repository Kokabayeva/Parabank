...
WebUI.click(findTestObject('Page_ParaBank  Welcome  Online Banking/article3NewOnlineAccountTransfers'))

WebUI.navigateToUrl(GlobalVariable.NEWS_URL)

WebUI.verifyElementText(findTestObject('Object Repository/Page_ParaBank  News/h1ParaBankNews'), expectedH1ParaBankNews)

WebUI.takeScreenshotAsCheckpoint('Article1Page')
