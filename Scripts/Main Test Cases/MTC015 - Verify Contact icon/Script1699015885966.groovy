...
WebUI.click(findTestObject('Object Repository/Page_ParaBank  Welcome  Online Banking/iconContact'))

WebUI.navigateToUrl(GlobalVariable.CONTACT_URL)

WebUI.verifyElementText(findTestObject('Object Repository/Page_ParaBank  Customer Care/h1CustomerCare'), expectedH1CustomerCareText)
