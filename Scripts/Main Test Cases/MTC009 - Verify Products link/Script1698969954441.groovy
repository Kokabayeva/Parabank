...
WebUI.click(findTestObject('Object Repository/Page_ParaBank  Welcome  Online Banking/lnkProducts'))

WebUI.navigateToUrl(GlobalVariable.PRODUCTS_URL)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Automated Software Testing Tool Suite _51757b/ParasoftLogo'), 
    '')
