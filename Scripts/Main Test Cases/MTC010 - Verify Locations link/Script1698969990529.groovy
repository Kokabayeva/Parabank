...
WebUI.click(findTestObject('Object Repository/Page_ParaBank  Welcome  Online Banking/lnkLocations'))

WebUI.navigateToUrl(GlobalVariable.SOLUTIONS_URL)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Automated Software Testing Solutions F_4f6c59/ParasoftLogo'), 
    0)
